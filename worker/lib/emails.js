...
export async function handleSendEmail(body, env, corsHeaders) {
  ...
  const dashboardLink = fullId ? `/RunPayway/dashboard?record=${encodeURIComponent(fullId)}` : "/RunPayway/dashboard";
...
<img src="/RunPayway/runpayway-logo-blue.png" alt="RunPayway" width="140" height="17" style="display:inline-block;height:auto;filter:brightness(0) invert(1);opacity:0.85;"/>
</td></tr>
...
<a href="/RunPayway/contact" style="font-size:10px;color:rgba(244,241,234,0.35);text-decoration:none;letter-spacing:0.06em;">CONTACT US</a>
</td></tr>
</table>
</td></tr>
...
export function followUpDay7(name, score, band, topAction, recordId, industry) {
  const link = recordId ? `/RunPayway/dashboard?record=${encodeURIComponent(recordId)}` : "/RunPayway/dashboard";
...
<tr><td style="padding:28px 40px 24px;"><img src="/RunPayway/runpayway-logo-blue.png" alt="RunPayway" width="140" height="17" style="height:auto;filter:brightness(0) invert(1);opacity:0.85;"/></td></tr>
...
<p style="font-size:10px;color:rgba(244,241,234,0.30);margin:0;">RunPayway\u2122 \u2014 Income Stability Score \u2014 <a href="/RunPayway/contact" style="color:rgba(244,241,234,0.35);text-decoration:none;">Contact</a></p>
</td></tr>
...
<a href="/RunPayway/pricing" style="display:inline-block;padding:14px 32px;color:#ffffff;font-size:14px;font-weight:600;text-decoration:none;">Reassess Your Score</a>
</td></tr></table>
...
<a href="/RunPayway/contact?subject=unsubscribe" style="font-size:10px;color:rgba(244,241,234,0.35);text-decoration:none;letter-spacing:0.06em;">UNSUBSCRIBE</a>
</td></tr>
</table>
</td></tr>
<tr><td style="height:24px;">&nbsp;</td></tr>
...
${nurtureCta("Take Your Free Assessment", "/RunPayway/begin")}
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:28px 0 0;">
...
${nurtureCta("Start Your Free Assessment", "/RunPayway/begin")}`;
...
${nurtureCta("See Where You Stand", "/RunPayway/begin")}`;
...
${nurtureCta("See Your Full Diagnostic", "/RunPayway/pricing")}
</td></tr></table>`;
...
${nurtureCta("See Your Full Action Plan", "/RunPayway/pricing")}`;
...
${nurtureCta("Unlock Your Full Diagnostic", "/RunPayway/pricing")}
</td></tr></table>`;
