// RunPayway — Simulation endpoint handlers

import { simulateScore, projectTimeline, SIMULATOR_PRESETS, INDUSTRY_PRESET_MAP } from "./scoring.js";
...
export async function handleSimulate(body, corsHeaders) {
  if (!body.inputs) {
...
export async function handleSimulateBatch(body, corsHeaders) {
...
export async function handleTimeline(body, corsHeaders) {
...
export function handleActionScripts(sector, request, corsHeaders) {
...
export function handlePresets(url, corsHeaders) {
