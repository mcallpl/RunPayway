    ...
    <section className="py-16 bg-slate-50">
      <div className="max-w-[1200px] mx-auto px-6 text-center">
        <button
          ...
          className="inline-block bg-navy-900 text-white px-8 py-4 text-lg font-medium hover:bg-navy-800 transition-colors focus:outline-none focus:ring-2 focus:ring-navy-900 focus:ring-offset-2 rounded-none"
        >
