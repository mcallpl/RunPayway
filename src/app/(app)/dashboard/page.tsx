            ...
            <div style={{ display: "flex", flexDirection: "column" as const, gap: 0 }}>
              {(() => {
                ...
                const tipsByIndustry: Record<string, Record<string, string>> = {
                  ...
                  sales_brokerage: {
                    recurrence: `Have you moved any accounts from one-time transactions to recurring billing or managed service agreements?`,
                    concentration: `Has your top account grown or shrunk as a share of total revenue? In sales, one big deal closing or falling through changes everything.`,
                    diversification: `Have you opened any new territories, verticals, or product lines that generate independent revenue?`,
                    forward: `How does your current pipeline compare to when you were assessed? More signed contracts means higher forward visibility.`,
                    variability: `Has your commission structure changed? Moving from pure commission to base + variable stabilizes this dimension.`,
                    labor: `Have you built any residual or trailing commission streams that pay you on renewals without new selling effort?`,
                  },
                  finance_banking: {
                    recurrence: `Has your compensation mix changed? A higher base-to-bonus ratio increases recurrence. A new book of recurring advisory fees counts too.`,
                    concentration: `Are you still dependent on one institution for the majority of your compensation? A job change or side practice changes this.`,
                    diversification: `Have you added any advisory, consulting, or investment income outside your primary role?`,
                    forward: `Has your employment contract been renewed or extended? Any new guaranteed compensation periods change this.`,
                    variability: `Has your bonus or production credit become more or less predictable? Changes in desk performance or market conditions affect this.`,
                    labor: `Have you built any fee-based advisory relationships or investment income that continues without your daily trading or production?`,
                  },
                  insurance: {
                    recurrence: `How is your renewal book performing? Higher retention rate means higher recurrence. Even a 5% change in retention significantly moves this.`,
                    concentration: `Has your largest account grown or have you added new accounts that reduce its share? In insurance, one large policy can dominate.`,
                    diversification: `Have you added new lines of coverage, commercial accounts, or fee-based consulting alongside your core production?`,
                    forward: `How many policies are up for renewal in the next 90 days with high retention probability? That is your forward visibility.`,
                    variability: `Has your mix of new business vs. renewals shifted? A higher renewal percentage creates more predictable monthly income.`,
                    labor: `Have you built any book-of-business income that generates renewals and trailing commissions without active selling?`,
                  },
                  legal_services: {
                    recurrence: `Have you signed any new retainer agreements or converted matter-based clients to ongoing advisory relationships?`,
                    concentration: `How many matters are currently carrying your billings? If your top 3 matters still represent 60%+ of revenue, concentration has not changed.`,
                    diversification: `Have you added clients in new practice areas or referral relationships that generate independent work?`,
                    forward: `Do you have more committed engagements or signed retainers for next quarter than at your last assessment?`,
                    variability: `Has your billable utilization become more consistent? Retainers and flat-fee arrangements stabilize variability in legal services.`,
                    labor: `Have you created any income that does not require your personal billable hours? Templates, courses, or of-counsel arrangements count.`,
                  },
                  healthcare: {
                    recurrence: `Has your employment contract been renewed, or have you added any recurring income like membership or concierge fees?`,
                    concentration: `Are you still employed by one system or institution? A side practice, locum work, or consulting engagement changes this.`,
                    diversification: `Have you added any income sources outside your primary employer — consulting, teaching, telemedicine, or speaking?`,
                    forward: `Has your contract term changed? A longer commitment means higher forward visibility. Month-to-month is the lowest.`,
                    variability: `Has your compensation model shifted? Moving from productivity-based to fixed salary stabilizes this. RVU changes destabilize it.`,
                    labor: `Have you built any income from content, courses, advisory boards, or intellectual property that continues without clinical work?`,
                  },
                  construction_trades: {
                    recurrence: `Have you signed any maintenance contracts, retainers, or recurring service agreements since your assessment?`,
                    concentration: `Has your largest project or client changed? In construction, one general contractor relationship can carry the entire business.`,
                    diversification: `Have you added new project types, geographic areas, or subcontracting relationships that generate independent revenue?`,
                    forward: `How does your signed backlog compare to when you were assessed? More signed jobs means higher forward visibility.`,
                    variability: `Has your project flow become more or less consistent? Seasonal patterns and bid timing affect this heavily in trades.`,
                    labor: `Have you hired crew that can run jobs without your personal presence on site? That is how trades professionals reduce labor dependence.`,
                  },
                  creative_media: {
                    recurrence: `Have you signed any retainer clients, subscription offerings, or recurring content agreements since your assessment?`,
                    concentration: `Has your client mix changed? If you have added or lost a major production client, your concentration has shifted.`,
                    diversification: `Have you added licensing, royalties, template sales, or a new service offering alongside your primary creative work?`,
                    forward: `Do you have more signed projects or committed bookings for the next 90 days than when you were assessed?`,
                    variability: `Has your project flow become more predictable? Retainer clients and recurring content deals stabilize this in creative work.`,
                    labor: `Have you created any digital products, templates, courses, or licensed content that generates revenue between projects?`,
                  },
                  education_training: {
                    recurrence: `Has your contract been renewed or extended? Have you added any recurring income like tutoring subscriptions or course royalties?`,
                    concentration: `Are you still dependent on one institution? A second teaching role, consulting engagement, or content business changes this.`,
                    diversification: `Have you added income from curriculum licensing, speaking, online courses, or consulting outside your primary institution?`,
                    forward: `Has your contract term changed? Multi-year agreements increase forward visibility significantly in education.`,
                    variability: `Has your compensation structure changed? Moving from adjunct/hourly to salaried or adding course income stabilizes this.`,
                    labor: `Have you created any course content, books, or frameworks that generate revenue without your live teaching hours?`,
                  },
                  retail_ecommerce: {
                    recurrence: `Have you added any subscription offerings, membership programs, or auto-ship products that create recurring revenue?`,
                    concentration: `Has your revenue become more diversified across channels (online, retail, wholesale) or are you still concentrated in one?`,
                    diversification: `Have you added new product lines, marketplace channels, or wholesale relationships since your assessment?`,
                    forward: `Do you have more pre-orders, contracted wholesale commitments, or subscription revenue locked in for next quarter?`,
                    variability: `Has your revenue become more or less seasonal? Subscription models and diversified channels reduce variability.`,
                    labor: `Have you automated any part of your operations — fulfillment, marketing, or customer service — that previously required your daily involvement?`,
                  },
                  hospitality: {
                    recurrence: `Have you added any catering contracts, event retainers, or corporate account agreements that create recurring revenue?`,
                    concentration: `Has your revenue diversified beyond walk-in traffic? Corporate accounts, catering, and delivery platforms reduce concentration.`,
                    diversification: `Have you added new revenue streams — events, packaged products, delivery partnerships, or branded merchandise?`,
                    forward: `Do you have more booked events, corporate commitments, or seasonal reservations than at your last assessment?`,
                    variability: `Has your revenue become more predictable? Corporate accounts and pre-booked events stabilize the daily traffic fluctuations.`,
                    labor: `Have you built any revenue streams that do not require you to be personally present — packaged products, licensing, or managed locations?`,
                  },
                  transportation: {
                    recurrence: `Have you signed any long-term contracts, dedicated routes, or recurring freight agreements since your assessment?`,
                    concentration: `Has your top shipper or broker grown or shrunk as a share of total revenue? One contract change can shift this significantly.`,
                    diversification: `Have you added new lanes, freight types, or broker relationships that generate independent revenue?`,
                    forward: `How much of next quarter's revenue is under signed contract vs. spot market? Contracted freight is forward visibility.`,
                    variability: `Has your load consistency improved? Dedicated contracts reduce the volatility of spot market dependence.`,
                    labor: `Have you added any trucks or drivers that generate revenue without your personal driving? Owner-operator to fleet is the transition.`,
                  },
                  agriculture: {
                    recurrence: `Have you signed any new forward contracts, CSA subscriptions, or recurring supply agreements since your assessment?`,
                    concentration: `Has your buyer base changed? Adding a farmers market, CSA, or wholesale channel reduces concentration on one buyer.`,
                    diversification: `Have you added new crops, livestock, agritourism, or value-added products that generate independent revenue?`,
                    forward: `How much of next season's production is under contract vs. speculative? Forward contracts are your visibility.`,
                    variability: `Has your revenue become more stable? Diversifying crops, adding storage, or contracting forward all reduce agricultural variability.`,
                    labor: `Have you added any income from land leasing, equipment rental, or value-added products that continue without your daily field work?`,
                  },
                  energy: {
                    recurrence: `Has your contract structure changed? Longer-term service agreements or regulatory mandates increase recurrence in energy.`,
                    concentration: `Are you still dependent on one employer, one contract, or one project site for the majority of your income?`,
                    diversification: `Have you added consulting, training, or advisory work alongside your primary role in the energy sector?`,
                    forward: `Has your employment or project contract been extended? In energy, contract duration is the primary driver of forward visibility.`,
                    variability: `Has your compensation become more or less tied to commodity prices, production volumes, or project milestones?`,
                    labor: `Have you built any income from royalties, licensing, intellectual property, or advisory roles that continue without on-site work?`,
                  },
                  manufacturing: {
                    recurrence: `Have you signed any new supply agreements, recurring purchase orders, or long-term production contracts?`,
                    concentration: `Has your largest customer's share of revenue changed? In manufacturing, losing or gaining one account can move this 30+ points.`,
                    diversification: `Have you added new product lines, customer segments, or distribution channels since your assessment?`,
                    forward: `How does your current order backlog compare to when you were assessed? A deeper backlog means higher visibility.`,
                    variability: `Has your production volume become more consistent? Long-term contracts and diversified customers reduce manufacturing variability.`,
                    labor: `Have you automated any production processes or built revenue streams (licensing, private label) that do not require your daily management?`,
                  },
                  nonprofit: {
                    recurrence: `Have you secured any new recurring grants, monthly donor programs, or annual funding commitments since your assessment?`,
                    concentration: `Has your funding base diversified, or is your largest funder still carrying a disproportionate share?`,
                    diversification: `Have you added new revenue streams — earned income, fee-for-service, events, or new grant sources?`,
                    forward: `How much of next year's funding is committed vs. pending applications? Committed multi-year grants increase visibility.`,
                    variability: `Has your funding cycle become more predictable? Monthly giving programs and multi-year grants stabilize nonprofit revenue.`,
                    labor: `Have you built any earned-revenue programs or endowment income that continues without active fundraising?`,
                  },
                  fitness_wellness: {
                    recurrence: `Have you added any membership packages, subscription programs, or auto-renewing session bundles since your assessment?`,
                    concentration: `Has your client base diversified, or are you still dependent on a small number of high-frequency clients?`,
                    diversification: `Have you added online programs, group classes, merchandise, or corporate wellness contracts alongside 1-on-1 sessions?`,
                    forward: `How many clients are on prepaid packages or committed memberships? That is your forward visibility in fitness.`,
                    variability: `Has your session volume become more consistent? Memberships and packages smooth the cancellation volatility.`,
                    labor: `Have you created any digital programs, courses, or content that generates revenue when you are not personally training?`,
                  },
                };
