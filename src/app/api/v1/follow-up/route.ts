...
function getEmailHtml(data: FollowUpRequest): { subject: string; html: string } {
    ...
    return {
      ...
      html: `
        <div style="font-family: 'Inter', system-ui, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px;">
          ...
          <h1 style="font-size: 24px; font-weight: 300; color: #1C1635; letter-spacing: -0.02em; margin-bottom: 16px;">Hi ${displayName},</h1>
          <p style="font-size: 15px; color: rgba(14,26,43,0.55); line-height: 1.65; margin-bottom: 20px;">
            Your Income Stability Score is <strong style="color: #1C1635;">${score}/100</strong> (${band}). Your Dashboard has your 12-week roadmap, PressureMap™, and ready-to-use scripts — have you opened it yet?
          </p>
          ...
          <a href="https://runpayway.peoplestar.com/dashboard" style="display: inline-block; padding: 14px 28px; background: #1C1635; color: #FFFFFF; border-radius: 8px; font-size: 14px; font-weight: 600; text-decoration: none;">Open Your Dashboard &rarr;</a>
  ...
  if (daysSince <= 60) {
    ...
    return {
      ...
      html: `
        <div style="font-family: 'Inter', system-ui, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px;">
          <div style="font-size: 11px; font-weight: 600; letter-spacing: 0.12em; color: #1F6D7A; text-transform: uppercase; margin-bottom: 20px;">RUNPAYWAY™</div>
          <h1 style="font-size: 24px; font-weight: 300; color: #1C1635; margin-bottom: 16px;">${daysSince} days since your assessment.</h1>
          <p style="font-size: 15px; color: rgba(14,26,43,0.55); line-height: 1.65; margin-bottom: 20px;">
            Your score of <strong style="color: #1C1635;">${score}</strong> has not changed because it is based on your income structure — not market conditions. The only way to improve it is to make a structural change.
          </p>
          <p style="font-size: 15px; color: rgba(14,26,43,0.55); line-height: 1.65; margin-bottom: 20px;">
          ...
          <a href="https://runpayway.peoplestar.com/simulator" style="display: inline-block; padding: 14px 28px; background: #1C1635; color: #FFFFFF; border-radius: 8px; font-size: 14px; font-weight: 600; text-decoration: none;">Open the Simulator &rarr;</a>
  ...
  return {
    ...
    html: `
      <div style="font-family: 'Inter', system-ui, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px;">
        <div style="font-size: 11px; font-weight: 600; letter-spacing: 0.12em; color: #1F6D7A; text-transform: uppercase; margin-bottom: 20px;">RUNPAYWAY™</div>
        <h1 style="font-size: 24px; font-weight: 300; color: #1C1635; margin-bottom: 16px;">It has been ${daysSince} days.</h1>
        <p style="font-size: 15px; color: rgba(14,26,43,0.55); line-height: 1.65; margin-bottom: 20px;">
        ...
        <a href="https://runpayway.peoplestar.com/pricing" style="display: inline-block; padding: 14px 28px; background: linear-gradient(135deg, #1C1635, #4B3FAE); color: #FFFFFF; border-radius: 8px; font-size: 14px; font-weight: 600; text-decoration: none;">Reassess Your Score &rarr;</a>
        <p style="font-size: 12px; color: rgba(14,26,43,0.30); margin-top: 32px;">RunPayway™ by PeopleStar Enterprises, INC.</p>
      </div>`,
  };
}
