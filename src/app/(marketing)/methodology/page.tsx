    ...
    <header ref={ref} style={{ backgroundColor: C.sand, paddingTop: m ? 104 : 152, paddingBottom: m ? 56 : 88, paddingLeft: px(m, t), paddingRight: px(m, t) }}>
      <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: m ? 30 : 64, fontWeight: 700, lineHeight: 1.1, letterSpacing: "-0.035em", color: C.navy, marginBottom: 16, ...fadeIn(visible, 50) }}>
          How RunPayway™ Measures Complex Income
        </h1>
        <p style={{ fontSize: m ? 20 : 28, fontWeight: 400, lineHeight: 1.4, color: C.teal, marginBottom: 24, ...fadeIn(visible, 80) }}>
          Approved rules. Versioned logic. Replayable results.
        </p>
        <p style={{ fontSize: m ? 16 : 18, color: muted, lineHeight: 1.6, maxWidth: 580, margin: "0 auto 24px", ...fadeIn(visible, 120) }}>
          RunPayway™ is the governed standard for complex-income measurement. It measures income structure under approved rules, with no machine learning and no subjective judgment. The same inputs are measured the same way every time.
        </p>
    ...
    <section ref={ref} style={{ backgroundColor: "#F5F4F1", paddingTop: m ? 60 : 104, paddingBottom: m ? 60 : 104, paddingLeft: px(m, t), paddingRight: px(m, t) }}>
      <div style={{ maxWidth: 880, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: m ? 40 : 64, ...fadeIn(visible) }}>
          <h2 style={{ fontSize: m ? 28 : 40, fontWeight: 600, lineHeight: 1.08, letterSpacing: "-0.028em", color: C.navy, marginBottom: 16 }}>What makes this different from other measurements?</h2>
          <p style={{ fontSize: m ? 16 : 18, color: muted, lineHeight: 1.6, maxWidth: 600, margin: "0 auto" }}>
            Most tools measure what income was. RunPayway™ measures how an income structure is built and how it holds if a source changes.
          </p>
        </div>

        <div style={{ display: m ? "block" : "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20, marginBottom: m ? 48 : 72, ...fadeIn(visible, 100) }}>
          {[
            { title: "Not a Credit Score", desc: "Credit scores measure borrowing history. RunPayway™ measures how an income structure holds under disruption. Different inputs. Different purpose.", icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0 1 12 2.944a11.955 11.955 0 0 1-8.618 3.04A12.02 12.02 0 0 0 3 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", color: C.teal },
            { title: "Not a Forecast", desc: "RunPayway™ does not predict what will happen. It measures how an income structure would hold up if conditions changed today.", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6", color: C.purple },
            { title: "Not Subjective", desc: "No judgment. No machine learning. No interpretation. Approved rules produce the same output every time.", icon: "M4 4v5h.582m15.356 2A8.001 8.001 0 0 0 4.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 0 1-15.357-2m15.357 2H15", color: C.navy },
          ].map((item, i) => (
        ...
        <div style={{ display: m ? "block" : "grid", gridTemplateColumns: "1fr 1fr", gap: 20, ...fadeIn(visible, 200) }}>
          ...
          <div style={{ backgroundColor: C.white, borderRadius: 16, padding: m ? 24 : 28, boxShadow: "0 1px 3px rgba(14,26,43,0.04), 0 4px 16px rgba(14,26,43,0.03)", marginBottom: m ? 16 : 0, position: "relative" as const, overflow: "hidden" }}>
            ...
            <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.08em", color: C.purple, marginBottom: 20 }}>HOW APPROVED RULES ARE VERSIONED</div>
            {[
              { label: "Approved rules are locked", desc: "Once approved, every rule version is immutable.", icon: "M12 15v2m-6 4h12a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2zm10-10V7a4 4 0 0 0-8 0v4h8z" },
              { label: "Outputs are comparable", desc: "Same rule version means directly comparable outputs.", icon: "M9 19v-6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v6M15 19v-6a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v6M9 13V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v8" },
              { label: "Changes are tested first", desc: "Test measurement-rule changes before launch with the Measurement Impact Simulator.", icon: "M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4" },
              { label: "Every output is stamped", desc: "The approved rule version is recorded, so outputs are replayable.", icon: "M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2" },
            ].map((item, i) => (
          ...
          <div style={{ backgroundColor: C.white, borderRadius: 16, padding: m ? 24 : 28, boxShadow: "0 1px 3px rgba(14,26,43,0.04), 0 4px 16px rgba(14,26,43,0.03)", position: "relative" as const, overflow: "hidden" }}>
            <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: `linear-gradient(90deg, #9B2C2C, #92640A, ${C.teal})` }} />
            <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.08em", color: C.teal, marginBottom: 20 }}>EXTERNAL-SAFE CLASSIFICATION</div>
            {[
              { label: "Volatile", desc: "The income structure depends heavily on the continued strength of its sources.", color: "#9B2C2C" },
              { label: "Moderate", desc: "The income structure relies on stability across key sources.", color: "#92640A" },
              { label: "Stable", desc: "The income structure has room to absorb change in its sources.", color: C.teal },
            ].map((b, i) => (
              <div key={i} style={{ display: "flex", gap: m ? 10 : 14, alignItems: "flex-start", padding: m ? "10px 12px" : "12px 14px", borderRadius: 10, backgroundColor: `${b.color}04`, marginBottom: i < 2 ? 8 : 0 }}>
  ...
  return (
    <section ref={ref} style={{ backgroundColor: C.navy, paddingTop: m ? 60 : 104, paddingBottom: m ? 60 : 104, paddingLeft: px(m, t), paddingRight: px(m, t), position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 880, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: m ? 40 : 64, ...fadeIn(visible) }}>
          <h2 style={{ fontSize: m ? 28 : 40, fontWeight: 600, lineHeight: 1.08, letterSpacing: "-0.028em", color: C.sand, marginBottom: 12 }}>System Integrity: What the Standard Guarantees</h2>
          <p style={{ fontSize: m ? 16 : 18, color: "rgba(244,241,234,0.50)", lineHeight: 1.6 }}>What the governed standard guarantees, and what it deliberately does not do.</p>
        </div>
        ...
        <div style={{ display: m ? "block" : "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: m ? 36 : 56, ...fadeIn(visible, 100) }}>
          ...
          <div style={{ padding: m ? 24 : 28, borderRadius: 14, backgroundColor: "rgba(255,255,255,0.03)", borderLeft: `3px solid ${C.teal}`, marginBottom: m ? 16 : 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
              ...
              <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.08em", color: C.teal }}>THE STANDARD GUARANTEES</div>
            </div>
            {[
          ...
          <div style={{ padding: m ? 24 : 28, borderRadius: 14, backgroundColor: "rgba(255,255,255,0.03)", borderLeft: "3px solid rgba(244,241,234,0.10)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
              ...
              <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.08em", color: "rgba(244,241,234,0.40)" }}>THE STANDARD DOES NOT</div>
            </div>
            {[
              "Make eligibility decisions or replace institutional policy",
              "Use machine learning or probability-based models in measurement",
        ...
        <div style={{ padding: m ? "18px 20px" : "18px 24px", borderRadius: 10, borderLeft: `3px solid ${C.teal}`, backgroundColor: "rgba(255,255,255,0.02)", ...fadeIn(visible, 200) }}>
          <p style={{ fontSize: 18, fontWeight: 600, color: C.sand, margin: 0, lineHeight: 1.5 }}>
            RunPayway™ is a governed measurement standard, not a financial product.
          </p>
          <p style={{ fontSize: 16, fontWeight: 400, color: "rgba(244,241,234,0.55)", margin: "8px 0 0", lineHeight: 1.5 }}>
            It defines how income structure is measured according to approved rules, not how decisions are made.
          </p>
        </div>
      </div>
    </section>
    ...
    <section ref={ref} style={{ backgroundColor: C.white, paddingTop: m ? 72 : 112, paddingBottom: m ? 72 : 112, paddingLeft: px(m, t), paddingRight: px(m, t) }}>
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" as const, gap: m ? 16 : 20, ...fadeIn(visible, 100) }}>
          {[
            {
              title: "The approved rule set is consistent and fixed",
              body: "RunPayway\u2122 measures income structure with a published, version-locked set of approved rules. Same inputs produce the same output, every time. No machine learning. No subjective adjustment. The methodology is transparent and auditable.",
            },
            {
              title: "Industry baselines are structural estimates",
              body: "When a measurement is compared with an industry baseline, that baseline is derived from structural income modeling across each sector, not from a census of individuals. Baselines are versioned separately from the approved rules. When enough new data warrants an update, a new version is published. Every measurement is calculated against the baseline in effect at the time it was produced.",
            },
            {
              title: "Rule weights are calibrated against structural income patterns",
              body: "The weighting across dimensions reflects how income-structure factors relate to real-world resilience. As outcome data accumulates over time, the approved rules are refined and updates are published transparently.",
            },
            {
              title: "The output reflects structure, not prediction",
              body: "RunPayway\u2122 does not predict whether a disruption will occur. It measures how an income structure is built and how it would behave if conditions changed. The output is a governed, external-safe classification of income structure, not a forecast of what will happen next.",
            },
          ].map((item, i) => (
    ...
    <section ref={ref} style={{ backgroundColor: C.navy, paddingTop: m ? 60 : 104, paddingBottom: m ? 64 : 112, paddingLeft: px(m, t), paddingRight: px(m, t), borderTop: "1px solid rgba(244,241,234,0.04)" }}>
      <div style={{ maxWidth: 640, margin: "0 auto", textAlign: "center" }}>
        <p style={{ fontSize: m ? 18 : 22, fontWeight: 600, color: C.sand, lineHeight: 1.35, marginBottom: 8, ...fadeIn(visible) }}>
          The rules are approved and fixed.
        </p>
        ...
        <p style={{ fontSize: m ? 15 : 16, fontWeight: 400, color: "rgba(244,241,234,0.60)", lineHeight: 1.6, maxWidth: 560, margin: "0 auto 28px", ...fadeIn(visible, 80) }}>
