...
function HeroSection() {
  ...
  return (
    <header ref={ref} style={{ backgroundColor: C.white, position: "relative", overflow: "hidden", paddingTop: m ? 72 : 160, paddingBottom: m ? 56 : 112, paddingLeft: px(m), paddingRight: px(m) }}>
