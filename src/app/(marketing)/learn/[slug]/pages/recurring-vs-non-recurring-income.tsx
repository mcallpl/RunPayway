...
export default function RecurringVsNonRecurringIncome() {
  return (
    <>
      ...
      {/* 12. CTA */}
      <LearnCTA
        heading="Understand Your Revenue Architecture"
        sub="Get a diagnostic score that quantifies your recurring revenue ratio and five other structural dimensions."
      />
