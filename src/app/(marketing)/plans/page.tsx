  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: C.white, fontFamily: sans }}>
      <style>{`
        ...
        .plans-card:hover {
          box-shadow: 0 12px 40px rgba(14,26,43,0.11);
        ...
        @media (max-width: 900px) {
          .plans-grid { flex-direction: column !important; max-width: 480px !important; margin: 0 auto !important; }
        }
        @media (max-width: 600px) {
          .plans-hero-pad { padding-left: 24px !important; padding-right: 24px !important; }
        }
      `}</style>

      {/* ── Hero ── */}
      <section
        className="plans-hero-pad"
        style={{
        ...
        >
          ...
          >
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              >
                one-time &middot; instant delivery
              </span>
            </div>
          ...
          >
            ...
            >
              Run assessments on behalf of clients, receive structured
              income data, and access white-label report delivery — all
              from a single advisor portal.
            </p>
            ...
            >
              ...
              {[
                ...
                >
                  ...
                  <span style={{ fontSize: 14, color: C.sandMuted, lineHeight: 1.45 }}>
                    {item}
                  </span>
                </div>
              ))}
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              >
                per report &middot; volume pricing
              </span>
            </div>
          ...
          <div
            ...
            style={{
              ...
              borderRadius: 20,
              border: `1px solid ${C.borderSoft}`,
              boxShadow: "0 8px 32px rgba(14,26,43,0.05)",
              padding: "36px 32px 32px",
              display: "flex",
              flexDirection: "column",
            }}
