...
/* ------------------------------------------------------------------ */
/* HERO SCORE PANEL — financial instrument reading                      */
/* ------------------------------------------------------------------ */
function HeroScorePanel() {
  return (
    ...
    >
      {/* Panel header */}
      <div className="px-6 sm:px-8 py-4 border-b" style={{ borderColor: B.sandDk }}>
        <span className="text-[10px] font-semibold tracking-[0.12em]" style={{ color: B.light }}>
          RUNPAYWAY™ · MODEL RP-1.0
        </span>
      </div>
      <div className="px-6 sm:px-8 py-6 sm:py-8">
        <div className="text-[10px] font-semibold uppercase tracking-[0.12em] mb-1" style={{ color: B.teal }}>
          Income Stability Score™
        </div>
        <div className="text-[64px] sm:text-[72px] font-semibold leading-none" style={{ color: B.navy }}>72</div>
        {/* Rule separator */}
        <div className="my-4" style={{ height: 1, backgroundColor: B.sandDk }} />
        ...
        {/* Rule separator */}
        <div className="mb-4" style={{ height: 1, backgroundColor: B.sandDk }} />
        <div className="text-[10px] font-semibold uppercase tracking-wider mb-1" style={{ color: B.light }}>
          Industry Percentile
        </div>
        <div className="text-[22px] font-semibold" style={{ color: B.navy }}>68th</div>
      </div>
    </div>
  );
}
      ...
      >
        <div className="max-w-[560px] mx-auto px-5 sm:px-6">
          <div
            ...
            style={{
              backgroundColor: "#ffffff",
              boxShadow: "0 16px 64px rgba(0, 0, 0, 0.3), 0 4px 16px rgba(0, 0, 0, 0.15)",
            }}
          >
            {/* Panel header */}
            ...
            <div className="px-5 sm:px-8 py-6 sm:py-8">
              ...
              <div style={{ marginBottom: 24 }}>
                <div className="text-[10px] font-semibold uppercase tracking-wider" style={{ color: B.teal, marginBottom: 4 }}>
                  Income Stability Score™
                </div>
                <div className="text-[48px] sm:text-[56px] font-semibold leading-none" style={{ color: B.navy }}>72</div>
              </div>

              {/* Rule */}
              <div style={{ height: 1, backgroundColor: B.sandDk, marginBottom: 24 }} />

              {/* Classification */}
              <div style={{ marginBottom: 24 }}>
                <div className="text-[10px] font-semibold uppercase tracking-wider" style={{ color: B.light, marginBottom: 4 }}>
                  Classification
                </div>
                <div className="text-[15px] font-medium" style={{ color: B.navy }}>Established Stability</div>
              </div>
              ...
              {/* Constraint */}
              <div className="p-4 rounded-lg" style={{ backgroundColor: B.sand, marginBottom: 24 }}>
                <div className="text-[10px] font-semibold uppercase tracking-wider" style={{ color: B.light, marginBottom: 4 }}>
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {["Income variability", "Income source count", "Recurring income", "Forward revenue visibility"].map((d) => (
              ...
              <div>
                ...
                <div className="text-[22px] font-semibold" style={{ color: B.navy }}>68th percentile</div>
              </div>
            </div>
          </div>
