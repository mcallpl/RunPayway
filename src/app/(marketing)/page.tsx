...
const INDUSTRIES = [
  ...
  { key: "education", slug: "education", name: "Education", constraint: "The ceiling is the structure", desc: "Your income is predictable because the system caps it. Stability is high, but so is the cost of staying \u2014 growth requires leaving.", prep: ["Know whether your income comes from one institution or multiple sources", "Know what your income would be if your primary position ended today", "Think about whether you have any income outside your primary teaching or instruction role"], unlocks: [{ before: "Income felt secure because the institution felt stable.", now: "You see how concentrated your income is in one source \u2014 and what position elimination actually does to your floor." }, { before: "Outside income felt like extra. You didn\u2019t account for what it did to your stability.", now: "You know how much a second source moves your score \u2014 and what the gap costs you in financial flexibility." }] },
