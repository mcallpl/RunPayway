...
function FaqSection({ openFaq, setOpenFaq }: { openFaq: number | null; setOpenFaq: (v: number | null) => void }) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "A 4-page diagnostic with AI-powered PressureMap intelligence specific to your industry, a personalized plain-English score interpretation, ranked risk scenarios, a structural action plan with projected score impact, tradeoff analysis, a 30-day roadmap, and lifetime access to the Stability Simulator. Every section is written for your exact operating structure and income model — not templates.",
    },
    {
      q: "How is this different from other income tools?",
      a: "Most tools measure how much you earn. RunPayway measures how your income holds up under disruption. The report is generated by AI trained on structural income patterns — every sentence is written specifically for your industry, your operating structure, and your income model. No two reports are the same.",
    },
    {
