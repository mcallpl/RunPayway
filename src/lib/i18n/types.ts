export interface Translations {
  ...
  howItWorks: {
    ...
    deliverItem1Title: string;
    deliverItem1Desc: string;
    deliverItem2Title: string;
    deliverItem2Desc: string;
    deliverItem3Title: string;
    deliverItem3Desc: string;
    deliverItem4Title: string;
    deliverItem4Desc: string;
    deliverItem5Title: string;
    deliverItem5Desc: string;
    deliverItem6Title: string;
    deliverItem6Desc: string;
    verifyTag: string;
    verifyTitle: string;
    verifyDesc1: string;
    verifyDesc2: string;
