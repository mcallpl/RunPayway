        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding-bottom:28px; border-bottom:1px solid ${sand};">
                    <img src="https://runpayway.peoplestar.com/RunPayway_Logo.svg" alt="RunPayway™" width="160" height="19" style="display:inline-block; height:auto;" />
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background-color:${sand}; border-radius:8px; padding:20px 24px;">
                    ...
                    <a href="https://runpayway.peoplestar.com/pricing" style="display:inline-block; padding:10px 24px; background-color:${brandNavy}; color:#ffffff; font-size:13px; font-weight:600; text-decoration:none; border-radius:12px;">See What the Diagnostic Includes</a>
                    ` : `
                    ...
                    <a href="https://runpayway.peoplestar.com/review" style="display:inline-block; padding:10px 24px; background-color:${brandNavy}; color:#ffffff; font-size:13px; font-weight:600; text-decoration:none; border-radius:12px;">View Full Report</a>
                    `}
                  </td>
                </tr>
              </table>
                ...
                <tr>
                  <td>
                    <p style="font-size:10px; color:${light}; margin:0;">
                      ...
                      Verify at <span style="font-weight:500; color:${brandNavy};">runpayway.peoplestar.com/verify</span>
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:24px 0; text-align:center;">
              ...
              <p style="font-size:10px; color:${light}; margin:0;">
                Confidential — Prepared for ${data.assessmentTitle || "Assessment Subject"} · <a href="https://runpayway.peoplestar.com/contact" style="color:${light}; text-decoration:none;">Contact Us</a>
              </p>
            </td>
          </tr>
