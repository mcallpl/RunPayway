...
export function adaptV2ToV1(r: AssessmentRecord): Record<string, unknown> {
  ...
  return {
    ...
    _v2: {
      ...
      surprising_insights: r.explainability.surprising_insights,
      tradeoff_narratives: r.explainability.tradeoff_narratives,
      one_thing_that_matters: r.explainability.one_thing_that_matters,
      reusable_framework: r.explainability.reusable_framework,
      predictive_warnings: r.explainability.predictive_warnings,
      behavioral_insights: r.explainability.behavioral_insights,
      execution_roadmap: r.execution_roadmap,
      script_templates: r.script_templates,
      normalized_inputs: r.normalized_inputs,
